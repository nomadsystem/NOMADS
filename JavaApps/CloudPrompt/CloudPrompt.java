...
public class CloudPrompt extends JApplet implements ActionListener
{
	private class NomadsAppThread extends Thread {
		CloudPrompt client; //Replace with current class name

		public NomadsAppThread(CloudPrompt _client) {
			client = _client;
		}
		public void run()    {			
