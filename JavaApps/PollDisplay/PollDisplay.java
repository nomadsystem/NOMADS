...
public class PollDisplay extends JApplet implements MouseListener, MouseMotionListener, ActionListener, Runnable {   
	...
	private class NomadsAppThread extends Thread {
		PollDisplay client; //Replace with current class name

		public NomadsAppThread(PollDisplay _client) {
			client = _client;
		}
		public void run()    {			
	...
	public void handle() //bite, s
	{
		...
		if (!(s.equalsIgnoreCase(""))) {
			...
			NGlobals.cPrint("PD: s " + s);
			NGlobals.cPrint("PD: response " + s);
			...
			NGlobals.cPrint("PD: response " + response);  // DISPLAY
