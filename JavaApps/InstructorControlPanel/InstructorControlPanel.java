...
public class InstructorControlPanel extends JApplet  implements  ActionListener {
    ...
    // v2.0
    InstructorGroupDiscuss myInstGrpDiscussPanel;
    JFrame instGrpDiscussFrame;
	...
	mymyInstGrpDiscussPanel = new myInstGrpDiscussPanel();
	mymyInstGrpDiscussPanel.init(studentControlPanelSand);
	instGrpDiscussFrame = new JFrame("Discussion");
	//Could add window listener here if we wanted to
	instGrpDiscussFrame.setDefaultCloseOperation(WindowConstants.DISPOSE_ON_CLOSE);
	instGrpDiscussFrame.setLocationRelativeTo(null);
	instGrpDiscussFrame.setPreferredSize(new Dimension(800,600));
	instGrpDiscussFrame.getContentPane().add(mymyInstGrpDiscussPanel);
	instGrpDiscussFrame.pack();
	...
	if( source == discussButton) {
	    ...
	    instGrpDiscussFrame.setVisible(true);
	    // xxx
