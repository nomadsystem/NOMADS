...
public class CloudPrompt extends JPanel implements ActionListener
{
	...
	public void init(NSand inSand)
	{
		...
		//set title
		title = new JLabel("<html><h1 style='color:black;font-size:150%'>NOMADS Cloud Prompt</h1></html>", JLabel.CENTER);
		top.add(title);
	...
	{
		//not implemented in Cloud Prompt ****STK 6/14/12
	}
	...
	public void actionPerformed(java.awt.event.ActionEvent ae)
	{
		...
		if (source == ask)
		{
			...
			mySand.sendGrain((byte)NAppID.CLOUD_PROMPT, (byte)NCommand.SEND_CLOUD_PROMPT, (byte)NDataType.BYTE, tLen, tStringAsBytes );
