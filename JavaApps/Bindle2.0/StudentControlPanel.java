...
public class StudentControlPanel extends JApplet  implements  ActionListener {
	...
	//    discussFrame.setVisible(true);
	    ...
	    //Thought Cloud Frame
  		...
  		//SoundSwarm Frame
  		mySoundSwarmPanel = new SoundSwarmPanel();
  		mySoundSwarmPanel.init();
  		soundSwarmFrame = new JFrame("Sand Pointer"); //***STK: Deal with name confusion
  		//Could add window listener here if we wanted to
  		soundSwarmFrame.setDefaultCloseOperation(WindowConstants.DISPOSE_ON_CLOSE);
  		soundSwarmFrame.setLocationRelativeTo(null);
  		soundSwarmFrame.getContentPane().add(mySoundSwarmPanel);
  		soundSwarmFrame.pack();
	  	//    discussFrame.setVisible(true);
  		
  		//UGroove Frame
//  		myUnityGroovePanel = new UnityGroovePanel();
//  		myUnityGroovePanel.init();
  		uGrooveFrame = new JFrame("Unity Groove"); //***STK: Deal with name confusion
  		//Could add window listener here if we wanted to
...
//			getAppletContext().showDocument(pollURL,"Poll"); 
		...
		{
			soundSwarmFrame.setVisible(true);
