...
public class UnityGrooveStudent extends JApplet implements ActionListener, Runnable
{
	private class NomadsAppThread extends Thread {
		UnityGrooveStudent client; //Replace with current class name

		public NomadsAppThread(UnityGrooveStudent _client) {
			client = _client;
		}
		public void run()    {			
